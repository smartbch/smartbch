...
func TestStaking(t *testing.T) {
	...
	stakingAcc, info = staking.LoadStakingAccAndInfo(ctx)
	ctx.Close(false)
	//require.Equal(t, 100+staking.GasOfValidatorOp*1 /*gasUsedFee distribute to validators*/ +600000 /*extra gas*/, stakingAcc.Balance().Uint64())
	require.Equal(t, uint64(0x7a184), stakingAcc.Balance().Uint64())
