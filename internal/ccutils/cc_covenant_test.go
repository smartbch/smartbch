...
func Test_RedeemSigScript(t *testing.T) {
	redeemScriptWithoutConstructorArgs := testutils.HexToBytes("5279009c63557957797e58797ea98800537a547a52567a577a587a53afc3519dc4519d537a6300cd0376a91454797e0288ac7e886700cd02a91454797e01877e88686d7551677b519d547956797e57797ea97b8800727c52557a567a577a53af00c600cc9d00cd02a914537a7e01877e885601189502b40095b26d5168")
	operatorPks := [][]byte{
		testutils.HexToBytes("02d86b49e3424e557beebf67bd06842cdb88e314c44887f3f265b7f81107dd6994"),
		testutils.HexToBytes("035c0a0cb8987290ea0a7a926e8aa8978ac042b4c0be8553eb4422461ce1a17cd8"),
	...
	sigScript, err := c.BuildRedeemSigScript([][]byte{
		testutils.HexToBytes("0x304402200653f28de78f72d732eed6c5e51b01b1e04e63df4e2ede593cf562dde37561f902207f8c8c51b30de396fc97e5e0f02d5b4e05d075e02768c694ade0ee0e315af73241"),
		testutils.HexToBytes("0x304402201607826e2f394990d35407db7b90c79994156bde08121565fa532c336921b66602203fcb3bee3c187af0f00b6060ae7348fd106cd62ade7d998f664821dde6023c9e41"),
	},
		testutils.HexToBytes("0x99c7e0b48a05cd6024b22cd490fcee30aa51d862"),
	)
	require.NoError(t, err)
	require.Equal(t, testutils.HexToBytes(""),
		sigScript)
}
...
func Test_RedeemTx(t *testing.T) {
	...
	unsignedTx, sigHash, err := c.GetRedeemTxSigHash(txid, vout, prevOutAmt, toAddr, outAmt)
	require.NoError(t, err)
