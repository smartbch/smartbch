...
if [ $NETWORK == "amber" ]; then
    docker build -f Dockerfile.optimized --build-arg SMARTBCH_VERSION=amber --build-arg CONFIG_VERSION=v0.0.4 --build-arg CHAIN_ID=0x2711 -t smartbch-amber:latest .
